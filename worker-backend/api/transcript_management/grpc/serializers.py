...
from .transcript_management_pb2 import FileManagementListResponse, FileManagementResponse, TranscriptionLogListResponse, TranscriptionLogResponse 
...
class FileManagementProtoSerializer(ModelProtoSerializer):
    ...
    class Meta:
        ...
        proto_class_list = FileManagementListResponse
